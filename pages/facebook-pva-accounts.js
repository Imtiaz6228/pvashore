...
export default function FacebookPVAAccounts() {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="buy facebook pva accounts, facebook phone verified accounts, facebook pva, verified facebook accounts, facebook accounts for sale, bulk facebook accounts, social media accounts" />
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Facebook PVA Accounts
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
            Premium Facebook accounts with phone verification for social media marketing and business growth.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=50&tier=fresh">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-3xl font-bold text-blue-600 mb-4">$95.00</div>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                ...
                <Link href="/checkout?service=facebook&quantity=100&tier=fresh">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 shadow-lg relative">
                ...
                <Link href="/checkout?service=facebook&quantity=300&tier=fresh">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=500&tier=fresh">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <h4 className="text-xl font-bold mb-4">8 Accounts</h4>
                <div className="text-3xl font-bold text-blue-600 mb-4">$22.00</div>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    8 Aged PVA Accounts
                ...
                <Link href="/checkout?service=facebook&quantity=8&tier=1-6months">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=20&tier=1-6months">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 shadow-lg relative">
                ...
                <Link href="/checkout?service=facebook&quantity=70&tier=1-6months">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <h4 className="text-xl font-bold mb-4">150 Accounts</h4>
                <div className="text-3xl font-bold text-blue-600 mb-4">$250.00</div>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    150 Aged PVA Accounts
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    Phone Verified
                ...
                <Link href="/checkout?service=facebook&quantity=150&tier=1-6months">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
          ...
          {/* 1-2 Years Old Facebook Accounts */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 text-blue-600">1-2 Years Old Facebook Accounts</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <h4 className="text-xl font-bold mb-4">10 Accounts</h4>
                <div className="text-3xl font-bold text-blue-600 mb-4">$40.00</div>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                ...
                <Link href="/checkout?service=facebook&quantity=10&tier=1-2years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=25&tier=1-2years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 shadow-lg relative">
                <div className="absolute top-4 right-4 bg-blue-500 text-white px-2 py-1 rounded text-xs font-bold">Popular</div>
                <h4 className="text-xl font-bold mb-4">75 Accounts</h4>
                <div className="text-3xl font-bold text-blue-600 mb-4">$200.00</div>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    75 Aged PVA Accounts
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    Phone Verified
                ...
                <Link href="/checkout?service=facebook&quantity=75&tier=1-2years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=150&tier=1-2years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
          ...
          {/* 2-5 Years Old Facebook Accounts */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 text-blue-600">2-5 Years Old Facebook Accounts</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=5&tier=2-5years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=15&tier=2-5years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 shadow-lg relative">
                ...
                <Link href="/checkout?service=facebook&quantity=50&tier=2-5years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <Link href="/checkout?service=facebook&quantity=100&tier=2-5years">
                  <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Order Now
                  </button>
                </Link>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Get Your Facebook PVA Accounts Today</h2>
          <p className="text-xl mb-8 text-blue-100">Connect with your audience through verified Facebook accounts</p>
          <button className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-all duration-300 transform hover:scale-105">
            Start Your Order
          </button>
        </div>
